...
Dado('que preencho os dados, utilizo o cnpj para cadastrar a filial que será excluida e clico em salvar') do
  fill_in 'Filial_Codigo', with: $codigo_aleatorio_10
  fill_in 'Filial_CEI', with: '294226088484'
  fill_in 'Filial_Telefone', with: $telefone
  fill_in 'Filial_Descricao', with: "Automação de testes + Exclusão filial CNPJ + #{$time.to_s}"
  find('label[for="rdCnpj"]').click
  fill_in 'Filial_CnpjCpf', with: $cnpj
  fill_in 'Filial_Endereco', with: $endereco_aleatorio
  fill_in 'Filial_Bairro', with: $bairro_aleatorio
...
Dado('que preencho os dados, utilizo o cpf para cadastrar a filial que será excluida e clico em salvar') do
  fill_in 'Filial_Codigo', with: $codigo_aleatorio_10
  fill_in 'Filial_CEI', with: '294226088484'
  fill_in 'Filial_Telefone', with: $telefone
  fill_in 'Filial_Descricao', with: "#{$razao_social_aleatoria} + Exclusão filial CPF + #{$time.to_s}"
  find('label[for="rdCpf"]').click
  fill_in 'Filial_CnpjCpf', with: $cpf
  fill_in 'Filial_Endereco', with: $endereco_aleatorio
  fill_in 'Filial_Bairro', with: $bairro_aleatorio
