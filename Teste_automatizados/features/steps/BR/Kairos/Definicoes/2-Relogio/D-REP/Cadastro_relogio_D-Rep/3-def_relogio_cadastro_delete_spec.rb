Dado('Acesso a tela de relogios para remover o modelo D Rep') do
  ...
  Quando('Seleciono o relogio cadastrado e clico em remover') do
  ...
  Quando('Clico para confirmar a remoção') do
  ...
  Então('Aguardo a mensagem de que o relogio foi removido com sucesso {string}') do |message_sucess|
