class Resources
    ...
    attr_reader :campos_empresa_espanhol
    attr_reader :campos_empresa_portugues_Pt
    attr_reader :resources_mensagem_obrigacao_empresa
    attr_reader :campos_cadastro_relogio_DRep
    attr_reader :campos_cadastro_relogio_DRep_pt
    attr_reader :campos_cadastro_relogio_DRep_mx
    attr_reader :campos_empresa_portugues_Pt
