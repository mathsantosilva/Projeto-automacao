Dado('Efetuo o login para verificar os resources da configuração de relogio da madis') do
  ...
  Quando('Acesso a tela de relogios para validar o resource da configuração da madis') do
  ...
  Quando('Acesso o cadastro da configuração de relogio para validar os resources da madis') do
  ...
  Então('Verifico os resources do relogio modelo D Rep da madis') do
  
    expect(page).to have_content 'Modelo:'
    expect(page).to have_content 'MD5715P'
